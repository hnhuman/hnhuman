...
import com.hnhuman.dao.base.BaseDao;
import com.hnhuman.dao.utils.Filter;
import com.hnhuman.dao.utils.Filter.Operator;
import com.hnhuman.dao.utils.Order;
import com.hnhuman.dao.utils.Order.Direction;
import com.hnhuman.dao.utils.Page;
import com.hnhuman.dao.utils.Pageable;
import com.hnhuman.entity.OrderEntity;
	...
	private synchronized String getAlias(Selection<?> selection) {
		if (selection != null) {
			...
			if (alias == null) {
				...
				alias = "kaolacheGeneratedAlias" + aliasCount++;
